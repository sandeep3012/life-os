...
void main() {
  ...
  test('invalid repeat ranges and weekdays are rejected', () {
    expect(
      () => RepeatSchedule.decode(
        RepeatSchedule(start: DateTime(2026), end: DateTime(2025)).encode(),
      ),
      throwsFormatException,
    );
    expect(
      () => RepeatSchedule.decode(
        RepeatSchedule(start: DateTime(2026), weekdays: [8]).encode(),
      ),
      throwsFormatException,
    );
  });
