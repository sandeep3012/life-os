...
void main() {
  ...
  test(
    'PDF generation supports zero expenses and a full-circle category',
    () async {
      for (final expense in [0, 10000]) {
        final report = FinanceReport(
          ...
          transactions: [],
          scopeLabel: 'Wallet · Food',
          previous: FinanceReport(
            period: ReportPeriod.forMonth(DateTime(2026, 8)),
