...
class RepeatSchedule {
  ...
  bool get hasOccurrence => between(
    start,
  ...
  bool includes(DateTime date) {
    ...
    switch (frequency) {
      ...
      case 'daily':
        return true;
      case 'weekly':
        return (weekdays.isEmpty ? [start.weekday] : weekdays).contains(
          d.weekday,
        );
      case 'monthly':
        return d.day == _clampedDay(d.year, d.month);
      case 'yearly':
        return d.month == start.month && d.day == _clampedDay(d.year, d.month);
      default:
        return false;
    }
  }
